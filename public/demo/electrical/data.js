...
const PANELS = {
  A: {
    ...
    circuits: [
      { slot: 0, side: "main", poles: 2, amps: 150, label: "Main Breaker", type: "main", notes: "Service disconnect feeding both bus stabs." },
  ...
  B: {
    ...
    circuits: [
      ...
      { slot: 24, side: "right", poles: 2, amps: 20, label: "Surge Protector", type: "standard", notes: "Whole-panel SPD — circuits 24/26." },
    ],
  },
};
